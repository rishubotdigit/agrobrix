...
class PlanPurchaseConfirmation extends Mailable implements ShouldQueue
{
    ...
    {
        return new Envelope(
            subject: 'Plan Purchase Confirmation - ' . config('app.name'),
        );
    }
    ...
    {
        return new Content(
            html: 'emails.plan-purchase-confirmation',
            with: [
