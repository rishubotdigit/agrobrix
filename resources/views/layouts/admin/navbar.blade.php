@php
    $notificationCount = \App\Models\Notification::where('seen', false)->whereNull('user_id')->count();
    $notifications = \App\Models\Notification::whereNull('user_id')->orderBy('created_at', 'desc')->limit(10)->get();
@endphp
