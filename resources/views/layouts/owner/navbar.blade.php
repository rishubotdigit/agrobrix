            ...
            <div class="flex items-center">
                ...
                <div class="flex-shrink-0">
                    <a href="{{ route('home') }}" class="flex items-center space-x-3">
                        ...
                        @else
                            <h1 class="text-xl font-bold text-gray-900">Agrobrix Owner</h1>
                        @endif
                    </a>
                </div>
            </div>
                    ...
                    <div id="notification-dropdown" class="absolute right-0 mt-2 w-80 bg-white rounded-md shadow-lg z-50 hidden">
                        <div class="py-1">
                            <div class="px-4 py-2 border-b border-gray-200 flex justify-between items-center">
                                ...
                                <a href="{{ route('owner.notifications.index') }}" class="text-xs text-gray-600 hover:text-gray-800">View all</a>
                            </div>
