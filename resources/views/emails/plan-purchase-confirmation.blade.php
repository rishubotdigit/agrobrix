...
<head>
    ...
    <style>
        ...
        .invoice-container { border: 1px solid #e5e7eb; padding: 20px; margin: 20px 0; background-color: #f9fafb; border-radius: 8px; }
...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="color: #059669; margin: 0;">Plan Purchase Confirmation</h1>
        </div>

        <div class="content">
            <p>Dear {{ $planPurchase->user->name }},</p>
            <p>Thank you for your purchase! Your plan has been successfully processed and is now active.</p>

            <div class="invoice-container">
                {!! $invoiceHtml !!}
            </div>

            <p>You can now enjoy all the features included in your plan. Visit your dashboard to start exploring.</p>
