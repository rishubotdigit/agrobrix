...
<body>
    <div class="container">
        <div class="header">
            ...
            <h1 style="color: #dc2626; margin: 0;">Property Rejected</h1>
        </div>

        <div class="content">
            <p>A property listing has been rejected on {{ config('app.name') }}.</p>
            ...
            <div class="property-details">
                ...
                <ul style="margin: 0; padding-left: 20px;">
                    ...
                    <li><strong>Rejected At:</strong> {{ $property->updated_at->format('Y-m-d H:i:s') }}</li>
                    <li><strong>Status:</strong> {{ ucfirst($property->status) }}</li>
                </ul>
            </div>

            <p>The property owner has been notified of the rejection.</p>
