...
@section('content')
<style>
/* Mobile responsiveness for role selection container */
...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-md w-full">
        <div id="role-container" style="width: 450px; margin: -92px;" class="bg-white/80 backdrop-blur-lg py-10 px-4 sm:px-6 md:px-8 lg:px-12 shadow-2xl rounded-3xl border border-white/20">
            <!-- Logo/Brand Section -->
