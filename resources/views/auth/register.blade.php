...
<div class="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
    <div class="max-w-3xl w-full">
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-4 flex items-center pointer-events-none">
                                <span class="text-gray-600 font-bold border-r border-gray-300 pr-2">+91</span>
                            </div>
                            <input id="mobile" name="mobile" type="tel" placeholder="Enter mobile number" autocomplete="tel" required maxlength="10"
                                   class="form-input block w-full px-4 py-4 pl-20 border border-gray-300 rounded-xl shadow-sm placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:border-emerald-500 transition-all duration-200 bg-gray-50/50 text-base">
                        </div>
                    </div>
        ...
        <div id="otp-container" class="hidden w-full max-w-lg mx-auto bg-white py-12 px-8 shadow-2xl rounded-3xl border border-gray-100 transfrom transition-all duration-300">
            <!-- OTP Header -->
            <div class="text-center mb-8">
                <div class="mx-auto h-20 w-20 bg-green-50 rounded-full flex items-center justify-center mb-6 shadow-sm border border-green-100">
                ...
                <div class="p-4 bg-gray-50 rounded-xl border border-gray-100 inline-block w-full">
                     <p class="text-gray-600 mb-1">We've sent a code to</p>
                     <p class="text-xl font-bold text-gray-900 tracking-wide">+91 <span id="otp-mobile"></span></p>
                </div>
            </div>
            ...
            <div class="space-y-6">
                <div>
                    <label for="otp-code" class="sr-only">Enter Verification Code</label>
                    <input id="otp-code" type="text" maxlength="6" placeholder="• • • • • •"
                           class="form-input block w-full px-4 py-5 border-2 border-gray-200 rounded-xl text-center text-4xl tracking-widest font-bold text-gray-800 focus:outline-none focus:ring-4 focus:ring-emerald-500/20 focus:border-emerald-500 transition-all duration-200 bg-white placeholder-gray-300" required>
                    <p class="text-xs text-center text-gray-500 mt-2">Enter the 6-digit code received on your mobile</p>
                </div>

                <div class="space-y-3 pt-2">
                    <button id="verify-otp" class="submit-btn w-full flex justify-center py-4 px-4 border border-transparent rounded-xl shadow-lg text-lg font-bold text-white bg-emerald-600 hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-emerald-500 transition-all duration-200 transform hover:scale-[1.01]">
                        Verify & Continue
                    </button>

                    <button id="resend-otp" class="w-full flex justify-center py-4 px-4 border border-gray-200 rounded-xl shadow-sm text-base font-semibold text-gray-600 bg-white hover:bg-gray-50 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-gray-200 transition-all duration-200">
                        Resend Code
                    </button>
                </div>

                <div class="text-center pt-4 border-t border-gray-100">
                    <button id="back-to-register" class="text-sm font-medium text-gray-500 hover:text-gray-700 transition-colors flex items-center justify-center mx-auto hover:underline">
