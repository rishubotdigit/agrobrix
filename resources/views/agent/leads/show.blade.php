...
<div class="mt-6 flex space-x-4">
    <a href="{{ route('agent.leads.index') }}" class="bg-gray-500 text-white px-6 py-2 rounded-lg hover:bg-gray-600 transition-colors">
        Back to Leads
    </a>
    <a href="{{ route('agent.leads.edit', $lead) }}" class="bg-blue-500 text-white px-6 py-2 rounded-lg hover:bg-blue-600 transition-colors">
        Edit Lead
    </a>
</div>
@endsection