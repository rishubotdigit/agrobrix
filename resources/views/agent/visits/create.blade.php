...
@section('content')
<div class="mb-8">
    <h1 class="text-3xl font-bold text-gray-900 mb-2">Schedule Property Visit</h1>
    <p class="text-gray-600">Schedule a visit for {{ $lead->buyer_name }} to view {{ $lead->property->title }}.</p>
</div>

<div class="bg-white shadow-md rounded-lg p-6">
    <form method="POST" action="{{ route('agent.visits.store', $lead) }}">
        @csrf
        ...
        <div class="mb-6">
            <label for="scheduled_at" class="block text-sm font-medium text-gray-700 mb-2">Visit Date & Time *</label>
            <input type="datetime-local" name="scheduled_at" id="scheduled_at"
                   class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                   required>
            <p class="text-sm text-gray-500 mt-1">Select a date and time for the property visit</p>
        </div>
        ...
        <div class="mb-6">
            ...
            <textarea name="notes" id="notes" rows="4"
                      class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500"
                      placeholder="Add any special instructions or notes for this visit..."></textarea>
        </div>
