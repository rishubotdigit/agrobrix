        ...
        <div class="prose prose-lg max-w-none">
            ...
            <div class="mb-12">
                ...
                <ul class="list-disc pl-6 text-gray-600 space-y-2 mb-4">
                    ...
                    <li><strong>Information Service:</strong> Our service is limited to providing a platform for advertisements and granting access to Seller contact details upon payment of a platform fee.</li>
                </ul>
            </div>
            ...
            <div class="mb-12">
                ...
                <ul class="list-disc pl-6 text-gray-600 space-y-2 mb-4">
                    ...
                    <li><strong>For Buyers:</strong> You agree to use the contact information provided only for the purpose of inquiring about the property. Any harassment of Sellers or misuse of data is strictly prohibited.</li>
            ...
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">5. Disclaimers & Limitation of Liability</h2>
                <ul class="list-disc pl-6 text-gray-600 space-y-2 mb-4">
                    ...
                    <li><strong>Transaction Risks:</strong> Agrobrix is not a party to any agreement between Buyers and Sellers. We are not liable for any financial loss, fraud, or legal disputes arising from transactions initiated through the Site.</li>
                    <li><strong>Physical Safety:</strong> Users are advised to exercise caution and ensure their own safety when visiting remote agricultural land parcels.</li>
                </ul>
            </div>

            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">6. Intellectual Property</h2>
            ...
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">7. Indemnity</h2>
                <p class="text-gray-600 leading-relaxed">
            ...
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">8. Modification & Termination</h2>
                <p class="text-gray-600 leading-relaxed">
            ...
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">9. Governing Law & Jurisdiction</h2>
                <p class="text-gray-600 leading-relaxed">
