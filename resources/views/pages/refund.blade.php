...
<section class="py-20 bg-white">
    <div class="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="prose prose-lg max-w-none">
            ...
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">ℹ️ 1. Nature of Service</h2>
            ...
            <div class="mb-12">
                ...
                <ul class="list-disc pl-6 text-gray-600 space-y-2">
                    ...
                    <li><strong>⚙️ Technical Failure:</strong> If a payment was successful but the plan was not activated on your dashboard due to a system error.</li>
                </ul>
            </div>
            ...
            <div class="mb-12">
                <h2 class="text-3xl font-bold text-gray-900 mb-6">✏️ 6. Modifications</h2>
                <p class="text-gray-600 leading-relaxed">
