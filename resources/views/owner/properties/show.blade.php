...
<div class="mb-8">
    <div class="flex items-center justify-between">
        ...
        <div class="flex space-x-3">
            <a href="{{ route('owner.properties.edit', $property) }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors">
                Edit Property
            </a>
            <a href="{{ route('owner.properties.index') }}" class="bg-gray-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-gray-700 transition-colors">
                Back to Properties
            </a>
        </div>
    </div>
...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-8">
    ...
    <div class="space-y-6">
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <dl class="space-y-3">
                <div>
                    ...
                    <dd class="text-sm text-gray-900">{{ $property->agent->name }}</dd>
                </div>
                <div>
                    <dt class="text-sm font-medium text-gray-500">Email</dt>
                    <dd class="text-sm text-gray-900">{{ $property->agent->email }}</dd>
                </div>
            </dl>
        </div>
        @endif
        ...
        <div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
            ...
            <div class="space-y-3">
                <a href="{{ route('owner.properties.edit', $property) }}" class="w-full bg-blue-600 text-white px-4 py-2 rounded-lg font-medium hover:bg-blue-700 transition-colors text-center block">
                    Edit Property
                </a>
