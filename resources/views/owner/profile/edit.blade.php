...
<form action="{{ route('owner.profile.update') }}" method="POST" enctype="multipart/form-data" class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
    @csrf
    @method('PUT')
    ...
    <div class="bg-white rounded-xl p-6 max-w-md w-full mx-4 shadow-xl">
        <div class="text-center">
            ...
            <div class="flex space-x-3">
                ...
                <form action="{{ route('owner.profile.delete') }}" method="POST" class="flex-1">
                    @csrf
