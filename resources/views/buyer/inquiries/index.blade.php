...
<div class="mb-8">
    ...
    <p class="text-gray-600">Track your property contact unlocks and follow-ups.</p>
</div>

<!-- Inquiries Table -->
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
    <h3 class="text-lg font-semibold text-gray-900 mb-6">Contact Inquiries</h3>
            ...
            <table class="min-w-full divide-y divide-gray-200">
                <thead class="bg-gray-50">
                    <tr>
                        ...
                        <th class="px-6 py-3 text-left text-xs font-medium text-gray-500 uppercase tracking-wider">Unlock Date</th>
                    ...
                    @foreach($inquiries as $inquiry)
                        <tr class="hover:bg-gray-50">
                            ...
                            <td class="px-6 py-4 whitespace-nowrap text-sm text-gray-900">
                                {{ $inquiry['unlock_date']->format('M d, Y') }}
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <div class="text-sm font-medium text-gray-900">{{ $inquiry['contact_name'] }}</div>
                                <div class="text-sm text-gray-500">{{ $inquiry['contact_email'] }}</div>
                                <div class="text-sm text-gray-500">{{ $inquiry['contact_mobile'] }}</div>
                            </td>
                            <td class="px-6 py-4 whitespace-nowrap">
                                <span class="inline-flex px-2 py-1 text-xs font-semibold rounded-full
                                    @if($inquiry['status'] == 'Contact Unlocked')
    ...
    @else
        <div class="text-center py-12">
            ...
            <p class="mt-1 text-sm text-gray-500">You haven't unlocked any property contacts yet.</p>
            <div class="mt-6">
