...
<div class="bg-white p-6 rounded-xl shadow-sm border border-gray-200">
    ...
    @else
        <div class="text-center py-12">
            ...
            <div class="mt-6">
                <a href="{{ route('search.advanced') }}" class="inline-flex items-center px-4 py-2 border border-transparent shadow-sm text-sm font-medium rounded-md text-white bg-primary hover:bg-emerald-700 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-primary">
                    Browse Properties
                </a>
            </div>
        </div>
