                    ...
                    <div class="flex flex-col sm:flex-row justify-between items-start gap-4">
                        <div class="flex-1">
                            ...
                            <p class="text-gray-600 flex items-center gap-2">
                                ...
                                @if($property->state || $property->district)
                                    ...
                                    @endif
                                @else
                                    {{ $property->area ?? $property->full_address ?? 'Location not specified' }}
                                @endif
                            </p>
                        </div>
                    ...
                    <div class="space-y-4 mb-6">
                        <div class="flex items-start gap-3">
                            ...
                            <div>
                                ...
                                <p class="text-base sm:text-lg text-gray-900">{{ $property->full_address }}</p>
                            </div>
                        </div>
