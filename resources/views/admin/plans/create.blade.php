...
@section('content')
    <div class="max-w-2xl mx-auto">
        <h1 class="text-3xl font-bold text-gray-800 mb-6">Create New Plan</h1>
        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form method="POST" action="{{ route('admin.plans.store') }}" id="plan-form">
                ...
                <div class="mb-4">
                    ...
                    <select name="role" id="role" class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('role') border-red-500 @enderror" required>
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="offer_price" id="offer_price" value="{{ old('offer_price') }}" step="0.01" min="0"
                ...
                <div id="buyer-fields" class="role-fields" style="display: none;">
                    <div class="mb-4">
                        ...
                        <input type="number" name="contacts_to_unlock" id="contacts_to_unlock" value="{{ old('contacts_to_unlock') }}" min="0"
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" name="persona" id="persona" value="{{ old('persona') }}"
                ...
                <div id="owner-agent-fields" class="role-fields" style="display: none;">
                    <div class="mb-4">
                        ...
                        <textarea name="features" id="features" rows="4"
                                  class="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-blue-500 @error('features') border-red-500 @enderror">{{ old('features') ? implode("\n", old('features')) : '' }}</textarea>
                        @error('features')
                            <p class="text-red-500 text-sm mt-1">{{ $message }}</p>
                        @enderror
