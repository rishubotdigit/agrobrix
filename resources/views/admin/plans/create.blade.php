        ...
        <div class="bg-white shadow-md rounded-lg p-6">
            <form method="POST" action="{{ route('admin.plans.store') }}">
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="max_listings" id="max_listings" value="{{ old('max_listings', 0) }}" min="0"
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="max_contacts" id="max_contacts" value="{{ old('max_contacts', 0) }}" min="0"
                ...
                <div class="mb-4">
                    ...
                    <input type="number" name="max_featured_listings" id="max_featured_listings" value="{{ old('max_featured_listings', 0) }}" min="0"
                ...
                <div class="mb-6">
                    ...
                    <input type="number" name="featured_duration_days" id="featured_duration_days" value="{{ old('featured_duration_days') }}" min="1"
