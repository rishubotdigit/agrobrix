...
<div class="bg-white rounded-xl shadow-sm border border-gray-200 p-6">
    ...
    <form id="propertyForm" action="{{ route('admin.properties.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
                    ...
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div class="md:col-span-2">
                            ...
                            <input type="text" name="slug" id="slug"
                                   class="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-primary focus:border-primary"
                                   placeholder="Leave empty to auto-generate from title" value="{{ old('slug') }}">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div>
                    ...
                    @enderror
                                    ...
                                    <div>
                                        <label class="block text-sm font-medium text-gray-700 mb-2">Feature Property</label>
                                        <div class="flex items-center">
                                            <input type="checkbox" name="featured" value="1" {{ old('featured') ? 'checked' : '' }} class="mr-2 text-primary focus:ring-primary">
                                            <span class="text-sm text-gray-700">Feature this property</span>
                                        </div>
                                    </div>
    ...
    document.getElementById('propertyForm').addEventListener('submit', function(e) {
        ...
        .then(data => {
            if (data.success) {
                updateLoaderStep(2, 100, 'Property created successfully!', 'Redirecting...');
                setTimeout(() => {
                    window.location.href = data.redirect || '{{ route("admin.properties.index") }}';
                }, 1000);
            } else {
