...
class DistrictSeeder extends Seeder
{
    ...
    public function run(): void
    {
        $districts = [
            ...
            'NL' => ['Chümoukedima', 'Dimapur', 'Kiphire', 'Kohima', 'Longleng', 'Mokokchung', 'Mon', 'Niuland', 'Noklak', 'Peren', 'Phek', 'Shamator', 'Tuensang', 'Wokha', 'Zunheboto'],
            ...
            'PB' => ['Amritsar', 'Barnala', 'Bathinda', 'Faridkot', 'Fatehgarh Sahib', 'Fazilka', 'Ferozepur', 'Gurdaspur', 'Hoshiarpur', 'Jalandhar', 'Kapurthala', 'Ludhiana', 'Mansa', 'Moga', 'Muktsar', 'Nawanshahr', 'Pathankot', 'Patiala', 'Rupnagar', 'Sahibzada Ajit Singh Nagar', 'Sangrur', 'Sri Muktsar Sahib', 'Tarn Taran'],
        ...
        foreach ($districts as $stateCode => $districtNames) {
            $state = State::where('code', $stateCode)->first();
            if ($state) {
                foreach ($districtNames as $districtName) {
                    District::updateOrCreate(
                        ['name' => $districtName, 'state_id' => $state->id]
                    );
                }
            }
        }
